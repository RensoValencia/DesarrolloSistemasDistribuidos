package com.sunat.pe.service;

import com.sunat.pe.Empresas;
 ...
 */
@Stateless
@Path("consultarPorRucRest")
public class EmpresasFacadeREST extends AbstractFacade<Empresas> {

    @PersistenceContext(unitName = "SunatJsonPU")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Empresas entity) {
        super.edit(entity);
    }
    ...
    public Empresas find(@PathParam("id") String id) {
