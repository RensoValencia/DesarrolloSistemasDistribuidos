...
import com.municipalidad.callao.jpacontroller.VehiculoFacade;
...
public class VehiculoController implements Serializable {
    ...
    @EJB
    private com.municipalidad.callao.jpacontroller.VehiculoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("com/municipalidad/callao/properties/messages").getString("VehiculoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("com/municipalidad/callao/properties/messages").getString("VehiculoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("com/municipalidad/callao/properties/messages").getString("VehiculoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
