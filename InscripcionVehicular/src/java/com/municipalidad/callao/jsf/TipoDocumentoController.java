...
import com.municipalidad.callao.jpacontroller.TipoDocumentoFacade;
...
public class TipoDocumentoController implements Serializable {
    ...
    @EJB
    private com.municipalidad.callao.jpacontroller.TipoDocumentoFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/municipalidad/callao/properties/messages").getString("TipoDocumentoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/municipalidad/callao/properties/messages").getString("TipoDocumentoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("com/municipalidad/callao/properties/messages").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/municipalidad/callao/properties/messages").getString("TipoDocumentoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("com/municipalidad/callao/properties/messages").getString("PersistenceErrorOccured"));
        }
    }
